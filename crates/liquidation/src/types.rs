...
use princeps_clob::{AccountId, Qty, Side};
...
/// model as `princeps_funding::Position`: the engine treats this as a
...
/// `princeps_clob::Action::SubmitMarket` and routes it through the matching
/// engine.
///
